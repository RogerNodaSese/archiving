<div class="container mt-5">
    @if(session('message'))
      ...
      @endif
      <form wire:submit.prevent="updateThesis" method="POST">
        @csrf
          ...
          <div class="form-group row mb-2">
            ...
            {{-- <div class="form-group row">
              ...
              <div class="col-md-4 col-lg-2 form-group ml-auto" style="">
                  <button type="submit" wire:loading.attr="disabled" wire:target="file" class="btn btn-success form-control" id="inputPassword">UPDATE</button>
                </div>
              </div>
            </div>
